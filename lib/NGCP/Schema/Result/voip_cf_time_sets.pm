package NGCP::Schema::Result::voip_cf_time_sets 2.007;
...
__PACKAGE__->table("provisioning.voip_cf_time_sets");
...
This module is a schema class for the NGCP database table "provisioning.voip_cf_time_sets".
...
=head1 TABLE: C<provisioning.voip_cf_time_sets>
...
Related object: L<NGCP::Schema::Result::voip_cf_periods>
