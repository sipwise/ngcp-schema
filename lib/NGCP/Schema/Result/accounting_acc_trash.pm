package NGCP::Schema::Result::accounting_acc_trash;
use Sipwise::Base;
...
NGCP::Schema::Result::accounting_acc_trash
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mu/37GBuXdBOnOAF3ef3xQ
