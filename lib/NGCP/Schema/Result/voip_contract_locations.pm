package NGCP::Schema::Result::voip_contract_locations 2.007;
...
This module is a schema class for the NGCP database table "provisioning.voip_contract_locations".
