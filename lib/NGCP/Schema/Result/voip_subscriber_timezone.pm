...
LEFT OUTER JOIN billing.contacts sc ON sc.id = s.contact_id
JOIN billing.contracts c ON c.id = s.contract_id
JOIN billing.contacts cc ON cc.id = c.contact_id
JOIN billing.resellers r ON r.id = cc.reseller_id
JOIN billing.contracts i ON i.id = r.contract_id
JOIN billing.contacts rc ON rc.id = i.contact_id
");
