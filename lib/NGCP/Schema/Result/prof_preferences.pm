...
__PACKAGE__->table("kamailio.prof_preferences");
...
NGCP::Schema::Result::prof_preferences
...
=head1 TABLE: C<prof_preferences>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nhxdSCoMw97jwOPT6srDIA
