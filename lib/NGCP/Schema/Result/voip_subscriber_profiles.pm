...
__PACKAGE__->add_unique_constraint("set_name_idx", ["set_id", "name"]);
...
Related object: L<NGCP::Schema::Result::voip_subscriber_profile_sets>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:fDZ8b6lI1e8Hp0SaFqG7xA
