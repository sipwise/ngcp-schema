package NGCP::Schema::Result::accounting_acc_backup;
use Sipwise::Base;
...
NGCP::Schema::Result::accounting_acc_backup
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:o1O1XlVAKepDZAvJ4HWkcQ
