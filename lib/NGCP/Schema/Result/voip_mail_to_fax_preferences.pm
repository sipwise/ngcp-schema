package NGCP::Schema::Result::voip_mail_to_fax_preferences 2.007;
...
This module is a schema class for the NGCP database table "provisioning.voip_mail_to_fax_preferences".
