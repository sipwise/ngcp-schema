package NGCP::Schema::Result::voip_subscriber_profile_sets 2.007;
...
This module is a schema class for the NGCP database table "provisioning.voip_subscriber_profile_sets".
