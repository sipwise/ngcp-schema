package NGCP::Schema::Result::voip_number_block_resellers 2.007;
...
This module is a schema class for the NGCP database table "billing.voip_number_block_resellers".
...
=head1 TABLE: C<billing.voip_number_block_resellers>
