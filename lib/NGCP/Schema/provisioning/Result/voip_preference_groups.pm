package NGCP::Schema::provisioning::Result::voip_preference_groups;
use Sipwise::Base;
use MooseX::NonMoose;
our $VERSION = '1.002';
...
__PACKAGE__->table("voip_preference_groups");
...
=head1 TABLE: C<voip_preference_groups>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:iGm/cuADbOcT/IwEDkcz5g
